...
- LSP support is opt-in and local-only: repomap checks project-local executables, PATH, and trusted user tool directories, but does not use plugin/MCP, install servers, bundle servers, or run a daemon.
